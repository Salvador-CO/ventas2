...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <form class="app-auth-container" action="" id="login-form" method="POST">
            ...
            <?php if (isset($alert)) {
                //<div class="alert alert-danger alert-style-light" role="alert"><i class="fas fa-times-circle"></i> ' . $alert . '</div>   
                echo '<script  >
                        swal("!Aviso¡", "' . $alert . '",{
            ...
            <div class="auth-submit">
                <button href="submit" class="btn btn-primary w-100">Ingresar</button>
            </div>
        </form>
    </div>
