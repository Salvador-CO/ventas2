...
$pdf->image("../../assets/images/logo.png", 15, 1, 15, 15, 'PNG');
$pdf->Ln(5);

$pdf->MultiCell(42, 5, utf8_decode($datos['nombre']), 0, 'C');
...
$pdf->Cell(42, 5, "Datos del cliente", 0, 1, 'C');
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(70, 5, "==============================================", 0, 1, 'C');
...
$pdf->Cell(30, 5, "==============================================", 0, 1, 'C');
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(42, 5, "Detalle de Producto", 1, 1, 'C');
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(30, 5, "==============================================", 0, 1, 'C');
...
$pdf->Cell(30, 5, 'Total Pagar', 0, 1, 'R');
